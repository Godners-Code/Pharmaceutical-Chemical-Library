...
![114-80-7.svg](../Images/114-80-7.svg)
...
- 常见别名：新斯的明、溴化新斯的明（Neostigmine bromide）、甲基硫酸新斯的明（Neostigmine methylsulfate），Quetiapine
...
- 八纲辨证：属里证、虚中夹实，表现为气虚、痰湿阻滞（肌无力）
- 五行归经：脾（肌肉）、肾（精气）、肝（筋）
- 中医类比作用：类似补气健脾、通络，同时有促津液外泄（汗、涎）
